...
console.log(valor)
//R: Ele irá adicionar 1 a i enquanto for menor que 5
...
for (let numero of lista) {
  if (numero > 18) {
    ...
    //R: Irá imprimir todos os números menores que 18 

    //b) Se eu quisesse acessar o **índice** de cada elemento dessa lista, o `for...of...` é suficiente? Se sim, o que poderia ser usado para fazer isso?
    //R: Sim, mas o jeito mais fácil é com console.log(lista.length)
...
*/
let animais = Number(ask.question("Quantos animais de estimacao voce tem? "))
let quaisOsNomesDosPets
let nomeDosPets =[""]
while(animais){
     if(animais){
        animais == 0
        ...
        animais > 0
        console.log(quaisOsNomesDosPets = ask.question("Qual o nome deles? "))
        nomeDosPets = quaisOsNomesDosPets
     } else {
        console.log("Isto não diz respeito a pergunta")
     }
}
